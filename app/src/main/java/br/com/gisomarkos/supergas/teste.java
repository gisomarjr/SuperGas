...
public class teste extends FragmentActivity {
    ...
    public void configMap(){
        ...
        map.setInfoWindowAdapter(new InfoWindowAdapter(){
            ...
            public View getInfoContents(Marker marker) {
                TextView tv = new TextView(teste.this);
            ...
            public View getInfoWindow(Marker marker) {
                LinearLayout ll = new LinearLayout(teste.this);
                ...
                Button bt = new Button(teste.this);
                bt.setText("Botão");
    ...
    public void getDistance(View view){
        ...
        Toast.makeText(teste.this, "Distancia: "+distance+" metros", Toast.LENGTH_LONG).show();
    }
    ...
    public void getLocation(View view){
        Geocoder gc = new Geocoder(teste.this);
        ...
        try {
            ...
            Toast.makeText(teste.this, "LatLng: "+ll, Toast.LENGTH_LONG).show();
